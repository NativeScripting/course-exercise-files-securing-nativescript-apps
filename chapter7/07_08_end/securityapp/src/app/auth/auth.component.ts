...
export class AuthComponent implements OnInit {
    ...
    private getFacebookUserName() {
        ...
        this.http.get<{ name: string }>('https://graph.facebook.com/v3.2/me?fields=name', { headers })
            .subscribe(result => {
    ...
    private getMicrosoftName() {
        ...
        this.http.get<{ displayName: string }>('https://graph.microsoft.com/v1.0/me', { headers })
            .subscribe(result => {
